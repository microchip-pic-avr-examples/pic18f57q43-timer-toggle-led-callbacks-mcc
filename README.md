...
![MCC Melody Example Components](images/GUID-ADDC2E58-F16C-46BD-A42F-D8FF02459622-high.png)
...
![TIMER Toggle LED, Polled Implementation](images/TIMER_Toggle_LED_Polled.png)
...
![Running the Timer Toogle LED example](images/RunningTimerToggleLED.png)

Two vertical cursors are added to verify the timer frequency. See configuration instructions below.
![DataVisualizer config Timer Toggle LED](images/DataVisualizerConfigTimerToggle%20LED.png)
